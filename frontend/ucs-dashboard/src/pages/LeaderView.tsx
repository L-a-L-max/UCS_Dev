...
const BATCH_COMMANDS = [
  ...
  { type: 'MARK_HOME', label: '\u5168\u90e8\u6807\u8bb0', icon: Home, color: 'bg-teal-600 hover:bg-teal-700' },
];
                        ...
                        <Button key={cmd.type}
                          ...
                          onClick={() => {
                            ...
                            sendBatchControlCommand(token, { uavIds, commandType: cmd.type, params: JSON.stringify(params), confirmed: true })
                              .then(res => { if (res.code === 0) setCommandFeedback({ uavId: uavIds.join(','), message: `${cmd.label} \u6307\u4ee4\u5df2\u53d1\u9001`, success: true }); })
                              .catch(() => {});
                            setTimeout(() => setCommandFeedback(null), 3000);
                          }}>
                ...
                <div className="mt-3 border-t border-slate-700 pt-2">
                  ...
                  <Button className="w-full text-xs h-7 bg-purple-600 hover:bg-purple-700 text-white"
                    onClick={() => {
                      ...
                      setCommandFeedback({ uavId: `${multiSelectedDrones.length}\u67b6`, message: '\u6279\u91cf\u8fd4\u822a\u6307\u4ee4\u5df2\u53d1\u9001', success: true });
                      setTimeout(() => setCommandFeedback(null), 3000);
                    }}>
