 ...
 *
 * 类比：就像保安定时巡逻，如果连续几圈发现整栋楼灯都灭了，
 *       就通知物业"可能停电了"，而不是等到天亮才发现。
 */
@Slf4j
@Component
...
public class GatewayHealthMonitor {
     ...
     *
     * 检查逻辑：
     *   1. 查询 Redis 中所有 drone:*:online 键
     *   2. 如果有在线无人机 → 重置计数器，如果之前告警过则发送恢复通知
     *   3. 如果没有在线无人机 → 计数器+1
     *   4. 计数器达到 OFFLINE_THRESHOLD → 广播 GATEWAY_OFFLINE 事件
     */
